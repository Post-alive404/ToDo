package com.dden.todo.client;

import com.dden.todo.client.domain.ToDo;
import com.dden.todo.client.error.ToDoErrorHandler;
...
//        restTemplate.setRequestFactory(new HttpComponentsClientHttpRequestFactory(client));
        Map<String, String> params = new HashMap<String, String>();
        params.put("id", id);
        restTemplate.postForObject(properties.getUrl() + properties.getBasePath() + "/{id}?_method=patch",null, String.class, params);
